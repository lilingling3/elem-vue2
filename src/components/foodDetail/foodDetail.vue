...
export default {
  ...
  computed:{
    evelArr(){
      ...
      // console.log(this.food.ratings.filter((data) => this.evelflag ? data.rateType === selectIndex-1 && data.text : data.rateType === selectIndex -1)
      // this.food.ratings.filter((data) => this.evelflag ? data.text : true
      return selectIndex?
       this.food.ratings.filter((data) => this.evelflag ? data.rateType === selectIndex-1 && data.text : data.rateType === selectIndex -1)
      :this.food.ratings.filter((data) => this.evelflag ? data.text : true)
    }
  },
...
>>>>>>> bc6bea4d4411a083c6541467b2e8cee764af8756
